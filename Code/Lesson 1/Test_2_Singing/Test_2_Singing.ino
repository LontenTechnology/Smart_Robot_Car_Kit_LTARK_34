...
//The setup function initializes the pin and calculates the length
void setup()
{
...
void loop()
{
  for(int x=0;x<length;x++)
  {
    ...
    delay(500*durt[x]);        // The 500 here controls the length of each note to determine the rhythm of the tune
    noTone(buzzer_pin);
  }
  delay(500);              
}
